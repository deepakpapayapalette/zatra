      ...
      <section className="space-top ">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-10 ">
            ...
            <div className="flex md:justify-end items-start min-w-[320px] relative  md:mb-0 mb-[45px]">
              <div className="relative flex flex-col md:pl-[50px]" >
                ...
                <img
                  ...
                  className="absolute  md:right-[-30px] right-0   bottom-[60px]  sm:w-[240px] w-[180px] h-auto object-cover  border-white zatra-bottom-img z-20"
                />
              </div>
            </div>
          </div>
